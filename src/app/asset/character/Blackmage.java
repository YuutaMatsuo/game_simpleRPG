...
public class Blackmage extends Human {
	private int job;

	// コンストラクタ
	public Blackmage(String name, int level, int hp, int maxHp, int mp, int atk, int def, int exp) {
		super("黒魔道士" + name, level, hp, maxHp, mp, atk, def, exp);
	}

	public Blackmage(String name, int job) {
		super("戦士" + name, 0, heroStatusTable.heroStatusMaster[job][0][0], heroStatusTable.heroStatusMaster[job][0][0],
